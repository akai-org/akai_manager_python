...
urlpatterns = [
    ...
    path('meetings/activate/<int:pk>/',
         meeting_views.activate, name="meeting_activate"),
    ...
    path('meetings/register/<str:code>/',
         meeting_views.register, name="meeting_register_code"),
